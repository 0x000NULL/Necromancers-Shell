...
static const char* g_event_names[] = {
    ...
    [EVENT_MEMORY_DISCOVERED] = "MEMORY_DISCOVERED",
    [EVENT_MEMORY_VIEWED] = "MEMORY_VIEWED",
    [EVENT_NPC_MET] = "NPC_MET",
    [EVENT_NPC_DIALOGUE_START] = "NPC_DIALOGUE_START",
    [EVENT_NPC_DIALOGUE_END] = "NPC_DIALOGUE_END",
    ...
    [EVENT_QUEST_FAILED] = "QUEST_FAILED",
    [EVENT_DIALOGUE_CHOICE_SELECTED] = "DIALOGUE_CHOICE_SELECTED"
};
